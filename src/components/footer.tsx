...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className="bg-white dark:bg-background-dark shadow-md py-8 mt-10 border-t border-gray-200 dark:border-gray-700"
    >
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        <div className="text-center md:text-left mb-4 md:mb-0">
          <h2 className="text-xl font-bold text-primary dark:text-secondary">Abdel Hamed Reda</h2>
...
function SocialIcon({ href, icon }: SocialIconProps) {
  return (
    <Link href={href} target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-accent transition-colors">
      {icon}
    </Link>
  );
}
