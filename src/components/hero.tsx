    ...
    >
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-6 md:gap-12">
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <h2 className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 font-medium mb-3 flex items-center space-x-2">
          ...
          >
            <p>Developer in</p>
            <RotatingText
              texts={["Next.js", "Angular", "MongoDB", "TypeScript"]}
          ...
          >
            ...
            technologies. With expertise in frontend development, I ensure
