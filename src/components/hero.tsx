    ...
    >
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-6 md:gap-12">
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <h2
            className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 font-medium mb-3"
          >
          ...
          >
            <p>Developer in</p>
            <RotatingText
  texts={["Next.js", "Angular", "Express.js", "MongoDB", "TypeScript"]}
...
/>
          ...
          <p   data-cursor="hover" className="mt-4 text-sm sm:text-base text-gray-600 dark:text-gray-400">
            I build scalable and high-performance web applications using modern technologies.
            With expertise in frontend and backend development, I ensure seamless user experiences
            and efficient backend architectures.
          </p>
        </div>
